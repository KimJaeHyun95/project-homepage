...
<body style="margin: auto; width: 600px;">
	...
	<c:if test="${login_status==true }">
		<h3 style="display: inline;"><a class="btn btn-info" href="/logout" style="position: relative; left: 420px;">Sign out</a></h3>
	</c:if>
	<c:if test="${login_status!=true }">
		<h3 style="display: inline;"><a class="btn btn-info" href="/loginform" style="position: relative; left: 420px;">Sign in</a></h3>
	</c:if>
		...
		<tr>
			...
			<th>wdate</th>
				...
				<c:if test="${pageList.pages<5 }">
					<tr>
            <td colspan="4" style="text-align: center; padding-left: 200px;">

               <ul class="pagination">
                  <c:forEach var="d" begin="1" end="${pageList.pages }">
	...
	<a href="javascript: upload()" class="btn btn-info" role="button">Go to upload</a>

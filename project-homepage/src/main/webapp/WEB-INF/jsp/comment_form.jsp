...
<body style="margin: auto; width: 500px;">
	...
	<h3>Comment</h3>
	<form action="/comment" method="post" enctype="multipart/form-data"style="display: inline;">
			<input type="hidden" name="pnum" value="${u.num }">
			<c:set var="id" value="${id }" />
			<input type="hidden" name="author" value="${id}">
			<label>title</label><input id="test" class="form-control" type="text" name="title" required="required"><br>
			<div class="form-group">
				<label for="comment">Comment:</label>
				<textarea class="form-control" rows="5" id="comment" name="contents" required="required" limitbyte="380"></textarea>
